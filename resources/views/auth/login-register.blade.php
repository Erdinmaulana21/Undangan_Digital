    ...
    <div class="container">
        <div class="forms-container">
            <div class="signin-signup">
                ...
                <form action="/register" method="POST" class="sign-up-form" lang="cus">
                    <h2 class="title">Daftar Sebagai :</h2>
                    <div class="btn-group" id="btn-switch">
                        <button lang="cus" class="btn">Customer</button>
                        <button lang="res" class="btn">Reseller</button>
                    </div>
